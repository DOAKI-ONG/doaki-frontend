        ...
        <div>
            <Header/>
                <div className="flex flex-col w-screen h-screen items-center justify-center bg-white text-black overflow-auto">
                    <div className="grid grid-cols-[120px_auto] w-screen mt-30 h-screen bg-white text-black">
                        <div className="flex flex-col items-center bg-white space-y-20 border-r-1">
                            <button className="mt-10 hover:opacity-80 transition duration-150 ease-in-out cursor-pointer mt-10" title="Perfil" onClick={()=> setPage("Perfil")}><UserRoundPen strokeWidth={1.5}/></button>
                        ...
                        <form className="flex flex-col justify-center items-center bg-white text-black mb-5">
                            <h2 className=" flex relative top-[42px] self-start ml-29.5 bg-white border-3 border-[#E4BA30] p-5 w-65 h-10 justify-center items-center rounded-tr-xl">{page? page : "Selecione algo..."} <span className="ml-5 bg-[#AED59B] w-3 h-3 rounded-tl-xl rounded-br-xl rounded-bl-xl "></span></h2>
